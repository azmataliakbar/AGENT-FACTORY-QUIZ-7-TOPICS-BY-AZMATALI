...
const icons = [
  ...
  /* Foundations Part 1 — book stack / foundation */
  <svg key="19" className="w-10 h-10" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042v14.25M6 3.75v14.25M18 3.75v14.25" />
  </svg>,
  /* Foundations Part 2 — graduation cap / next steps */
  <svg key="20" className="w-10 h-10" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342" />
  </svg>,
  /* CYNW Part 1 — code bracket / terminal */
  <svg key="21" className="w-10 h-10" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5" />
  </svg>,
  /* CYNW Part 2 — clipboard with check */
  <svg key="22" className="w-10 h-10" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.35 3.836c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15a2.25 2.25 0 0 1 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m8.9-4.414c.376.023.75.05 1.124.08 1.131.094 1.976 1.057 1.976 2.192V16.5A2.25 2.25 0 0 1 18 18.75h-2.25m-7.5-10.5H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V18.75m-7.5-10.5h6.375c.621 0 1.125.504 1.125 1.125v9.375m-8.25-3 1.5 1.5 3-3.75" />
  </svg>,
  /* CYNW Part 3 — desktop / computer */
  <svg key="23" className="w-10 h-10" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 17.25v1.007a3 3 0 0 1-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0 1 15 18.257V17.25m6-12V15a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 15V5.25m18 0A2.25 2.25 0 0 0 18.75 3H5.25A2.25 2.25 0 0 0 3 5.25m18 0V12a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 12V5.25" />
  </svg>,
  /* CYNW Part 4 — shield / safety */
  <svg key="24" className="w-10 h-10" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" />
  </svg>,
  /* WAI Part 1 — brain / neural */
  <svg key="25" className="w-10 h-10" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 0 1 4.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0 1 12 15a9.065 9.065 0 0 0-6.23.693L5 14.5m14.8.8 1.402 1.402c1.232 1.232.65 3.318-1.067 3.611A48.309 48.309 0 0 1 12 21c-2.773 0-5.491-.235-8.135-.687-1.718-.293-2.3-2.379-1.067-3.61L5 14.5" />
  </svg>,
  /* WAI Part 2 — lightbulb / insight */
  <svg key="26" className="w-10 h-10" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
...
export default function Home() {
  ...
  const foundationsParts = quizParts.slice(18, 20);
  const whatAiActuallyIsParts = quizParts.slice(24);
  ...
  const codeYouNeverWriteParts = quizParts.slice(20, 24);
  const skillsConnectorsParts = quizParts.slice(16, 18);
  const allTopicsParts = quizParts.slice(26);
  ...
  return (
    <main className="flex-1 flex flex-col items-center justify-center px-4 py-12">
      ...
      {/* ── Section 2: Foundations (Everyone) ── */}
      <div className="w-full max-w-2xl mt-8">
        <p className="text-xs font-semibold uppercase tracking-widest text-rose-400/70 mb-4 text-center">
          Foundations (Everyone)
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {foundationsParts.map((part, i) => (
            <Link
              key={part.id}
              href={`/quiz/${part.id}`}
              className="group relative overflow-hidden rounded-2xl border border-slate-700/50 bg-slate-800/40 p-6 transition-all duration-300 hover:border-slate-600 hover:bg-slate-800/60 hover:-translate-y-1 hover:shadow-xl hover:shadow-rose-500/10 animate-slide-up"
              style={{ animationDelay: `${i * 100}ms`, animationFillMode: "both" }}
            >
              <div className={`absolute top-0 right-0 w-32 h-32 rounded-bl-full bg-gradient-to-br ${part.color} opacity-10 group-hover:opacity-20 transition-opacity`} />
              <div className="relative z-10">
                ...
                <h2 className="text-lg font-semibold text-white mb-1.5 group-hover:text-rose-300 transition-colors">
                  {part.title}
                </h2>
                <p className="text-sm text-slate-400 leading-relaxed">
                  {part.subtitle}
                ...
                <div className="flex items-center gap-2 mt-4 pt-4 border-t border-slate-700/30">
                  <span className="text-xs text-slate-500">{part.questions.length} questions</span>
                  <span className="text-xs text-slate-600">•</span>
                  <span className="text-xs text-rose-400 group-hover:text-rose-300 transition-colors font-medium">
                    Start quiz →
                  </span>
                </div>
              </div>
      ...
      {/* ── Section 3: What AI Actually Is ── */}
      <div className="w-full max-w-2xl mt-8">
        <p className="text-xs font-semibold uppercase tracking-widest text-violet-400/70 mb-4 text-center">
          What AI Actually Is
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {whatAiActuallyIsParts.map((part, i) => (
            <Link
              key={part.id}
              href={`/quiz/${part.id}`}
              className="group relative overflow-hidden rounded-2xl border border-slate-700/50 bg-slate-800/40 p-6 transition-all duration-300 hover:border-slate-600 hover:bg-slate-800/60 hover:-translate-y-1 hover:shadow-xl hover:shadow-violet-500/10 animate-slide-up"
              style={{ animationDelay: `${i * 100}ms`, animationFillMode: "both" }}
            >
              <div className={`absolute top-0 right-0 w-32 h-32 rounded-bl-full bg-gradient-to-br ${part.color} opacity-10 group-hover:opacity-20 transition-opacity`} />
              <div className="relative z-10">
                ...
                <h2 className="text-lg font-semibold text-white mb-1.5 group-hover:text-violet-300 transition-colors">
                  {part.title}
                </h2>
                <p className="text-sm text-slate-400 leading-relaxed">
                  {part.subtitle}
      ...
      {/* ── Section 4: The Agent Factory Thesis ── */}
      <div className="w-full max-w-2xl mt-8">
      ...
      {/* ── Section 5: The AI Operating Layer ── */}
      <div className="w-full max-w-2xl mt-8">
      ...
      {/* ── Section 6: Quick Start — Crash Courses ── */}
      <div className="w-full max-w-2xl mt-8">
      ...
      {/* ── Section 7: AI Prompting in 2026 ── */}
      <div className="w-full max-w-2xl mt-8">
      ...
      {/* ── Section 8: Markdown In, HTML Out ── */}
      <div className="w-full max-w-2xl mt-8">
      ...
      {/* ── Section 9: Code You Never Write ── */}
      <div className="w-full max-w-2xl mt-8">
        <p className="text-xs font-semibold uppercase tracking-widest text-emerald-400/70 mb-4 text-center">
          Code You Never Write
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {codeYouNeverWriteParts.map((part, i) => (
            <Link
              key={part.id}
              href={`/quiz/${part.id}`}
              className="group relative overflow-hidden rounded-2xl border border-slate-700/50 bg-slate-800/40 p-6 transition-all duration-300 hover:border-slate-600 hover:bg-slate-800/60 hover:-translate-y-1 hover:shadow-xl hover:shadow-emerald-500/10 animate-slide-up"
              style={{ animationDelay: `${i * 100}ms`, animationFillMode: "both" }}
            >
              <div className={`absolute top-0 right-0 w-32 h-32 rounded-bl-full bg-gradient-to-br ${part.color} opacity-10 group-hover:opacity-20 transition-opacity`} />
              <div className="relative z-10">
                ...
                <h2 className="text-lg font-semibold text-white mb-1.5 group-hover:text-emerald-300 transition-colors">
                  {part.title}
                </h2>
                <p className="text-sm text-slate-400 leading-relaxed">
                  {part.subtitle}
      ...
      {/* ── Section 10: Skills & Connectors Crash Course ── */}
      ...
      {/* ── Section 11: ALL TOPICS MASTERY QUIZ ── */}
      <div className="w-full max-w-2xl mt-8 mb-8">
        <p className="text-xs font-semibold uppercase tracking-widest text-white/60 mb-4 text-center">
          🏆 All Topics Mastery Quiz
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {allTopicsParts.map((part, i) => (
            <Link
              key={part.id}
              href={`/quiz/${part.id}`}
              className="group relative overflow-hidden rounded-2xl border border-amber-500/30 bg-gradient-to-br from-amber-900/20 to-amber-950/20 p-6 transition-all duration-300 hover:border-amber-400/50 hover:bg-amber-900/30 hover:-translate-y-1 hover:shadow-xl hover:shadow-amber-500/10 animate-slide-up"
              style={{ animationDelay: `${i * 100}ms`, animationFillMode: "both" }}
            >
              <div className="absolute top-0 right-0 w-32 h-32 rounded-bl-full bg-gradient-to-br from-amber-400/20 to-yellow-500/10 opacity-30 group-hover:opacity-40 transition-opacity" />
              <div className="relative z-10">
                <div className="text-amber-300 mb-4 group-hover:text-amber-200 transition-colors">
                  <svg className="w-10 h-10" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
                  </svg>
                </div>
                <span className="inline-block text-xs font-semibold uppercase tracking-wider text-amber-500/80 mb-2">
                  {part.concepts}
                </span>
                <h2 className="text-lg font-semibold text-white mb-1.5 group-hover:text-amber-200 transition-colors">
                  {part.title}
                </h2>
                <p className="text-sm text-slate-400 leading-relaxed">
                  {part.subtitle}
